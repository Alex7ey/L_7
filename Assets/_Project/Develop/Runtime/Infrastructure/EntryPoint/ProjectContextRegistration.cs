...
namespace Assets._Project.Develop.Runtime.Infrastructure.EntryPoint
{
    public class ProjectContextRegistration
    {
        ...
        private static ResourcesAssetsLoader CreateResourceAssetsLoader(DIContainer container) 
            => new ResourcesAssetsLoader();

        private static ConfigsProviderService CreateConfigsProviderService(DIContainer container)
            => new ConfigsProviderService(container.Resolve<IConfigsLoader>());
        ...
        private static ViewsFactory CreateViewFactory(DIContainer container) 
        ...
        private static InventoryService CreateInventoryService(DIContainer container)
            => new InventoryService(container.Resolve<PlayerDataProvider>());
    }
}